...
Source0  : https://files.pythonhosted.org/packages/a1/a3/6c792f3b2fcd8dd211752dc7105bd2986d49c4b8cbc35ef433f17b0bf178/terminado-0.10.0.tar.gz
...
%prep
%setup -q -n terminado-0.10.0
cd %{_builddir}/terminado-0.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621350182
...
cp %{_builddir}/terminado-0.10.0/LICENSE %{buildroot}/usr/share/package-licenses/terminado/c469161e7fddd1ac349b03fa2732d18e96c579d2
