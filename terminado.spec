...
%prep
%setup -q -n terminado-0.9.2
cd %{_builddir}/terminado-0.9.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611278884
...
cp %{_builddir}/terminado-0.9.2/LICENSE %{buildroot}/usr/share/package-licenses/terminado/c469161e7fddd1ac349b03fa2732d18e96c579d2
