...
Version  : 0.8
Release  : 8
URL      : http://pypi.debian.net/terminado/terminado-0.8.tar.gz
Source0  : http://pypi.debian.net/terminado/terminado-0.8.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1511797425
