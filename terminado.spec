...
Source0  : https://files.pythonhosted.org/packages/e6/7d/509f24644348856e2eff7328ad7294127d85eccbb4ac049125ff02caf979/terminado-0.9.5.tar.gz
...
%prep
%setup -q -n terminado-0.9.5
cd %{_builddir}/terminado-0.9.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620749043
...
cp %{_builddir}/terminado-0.9.5/LICENSE %{buildroot}/usr/share/package-licenses/terminado/c469161e7fddd1ac349b03fa2732d18e96c579d2
