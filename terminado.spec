...
Source0  : https://files.pythonhosted.org/packages/e1/83/0ea6eee5c5fd82278ebce1567e2d6703a97ff19fd4e07b9361894a64dfbb/terminado-0.10.1.tar.gz
...
%prep
%setup -q -n terminado-0.10.1
cd %{_builddir}/terminado-0.10.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623426486
...
cp %{_builddir}/terminado-0.10.1/LICENSE %{buildroot}/usr/share/package-licenses/terminado/c469161e7fddd1ac349b03fa2732d18e96c579d2
